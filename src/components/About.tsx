          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                criando soluções digitais inovadoras. Minha jornada começou com curiosidade sobre 
                como as coisas funcionam e evoluiu para uma carreira dedicada a transformar ideias 
                em realidade através do código.
              </p>
              
              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                Especializo-me em desenvolvimento full-stack, com foco em React, Node.js e 
                tecnologias modernas. Acredito que o bom código não é apenas funcional, mas 
                também elegante e sustentável. Estou sempre aprendendo novas tecnologias e 
                metodologias para me manter atualizado neste campo em constante evolução.
              </p>

              <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                Quando não estou codando, gosto de compartilhar conhecimento, contribuir para 
                projetos open-source e explorar novas tendências em tecnologia. Meu objetivo 
                é sempre entregar soluções que não apenas atendam aos requisitos técnicos, 
                mas que também proporcionem uma excelente experiência para o usuário final.
              </p>
            </div>
